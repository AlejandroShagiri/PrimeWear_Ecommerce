...
const Category = () => {
    ...
    useEffect(() => {
        ...
        //gets me an array of all the categories 
        const catFilter = Object.values(item.reduce((object, {category})=>{
            object[category]={category}
            return object;
        },{}))

        const catItems = item.filter((item) => item.category === category);
    ...
    return (
        ...
        <>
        {
            ...
            <LoadingPage/>
            :
            <Container>{!item ? <Loading>Loading...</Loading> :
            <div>
                <Title>By Categories:</Title>
                ...
                <ItemCards> {!category ? <SelectCat>Please Select a category</SelectCat> : 
                <>
                    {catItems.map((object) => {
                        return (
